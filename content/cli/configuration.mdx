...
| `quality.analyzer.allowLegacyV4` | `false` | Permit the retired Code Analyzer v4 (`sf scanner run`) when v5 is unavailable — results are labeled non-authoritative; same as `quality --allow-legacy-analyzer`. Removed at 1.0 |

...
| **Dependencies** | D3 force-directed component dependency graph across Apex, triggers, Visualforce pages/components, Flows, LWC & Aura (with Custom Object/Field as opt-in source types); capped at 5000 edges with a truncation banner | `/api/dependencies` |

---
title: Features
description: All 38 opt-in features of the SFDT SF Helper Chrome extension, grouped by the Salesforce context where they run.
---
...
The extension ships **38 features**. Every feature is **opt-in** — toggle it on or off in the

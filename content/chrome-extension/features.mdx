...
| `api-version-audit` | Setup pill (`API v67 · 2 behind`) that expands to per-type API-version histograms (Apex classes/triggers, active Flows) with below-floor rows highlighted and an org-max footer; amber when anything is below the shared health floor |

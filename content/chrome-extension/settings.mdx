...
| `soql-bulk-delete` | Deletes records, irreversibly, from the rows a SOQL query returned — see [Bulk delete from a SOQL result set](/chrome-extension/features#bulk-delete-from-a-soql-result-set-soql-bulk-delete) |
